      ...
      <div className="w-full h-screen flex flex-col items-center px-4 md:hidden">
        <div className="w-full max-w-[375px] flex flex-col gap-6">
          ...
          <div className="text-center">
            <h1 className="text-[32px] font-bold text-[#232323]">Sign up</h1>
          ...
          >
            ...
            <button className="w-full bg-[#367AFF] text-white rounded-xl p-4 font-semibold hover:bg-[#3679ffcf]">
              {otpSent ? "Sign up" : "Get OTP"}
            </button>
          </form>
          <GoogleLogin
